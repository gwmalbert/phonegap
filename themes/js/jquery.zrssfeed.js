...
(function($){
	...
	var _process = function(e, data, options) {
		...
		// Add body
		//html += '<ul id="hello" data-role="listview" data-theme="a">';
		// Add feeds
		for (var i=options.offset; i<feeds.entries.length; i++) {
			...
			rowArray[rowIndex]['html'] = '<'+ options.titletag +'><a class="ui-link-inherit" href="'+ options.linkredirect + feedLink +'" title="View this feed at '+ feeds.title +'">'+ entry.title +'</a></'+ options.titletag +'>'
			...
			if (options.content) {
				...
				if (options.linkcontent) {
					content = '<a class="ui-link-inherit" href="'+ options.linkredirect + feedLink +'" title="View this feed at '+ feeds.title +'">'+ content +'</a>'
				}
